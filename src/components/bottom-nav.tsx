        ...
        <div className="flex items-center justify-around max-w-lg mx-auto h-16">
          ...
          <Link
            ...
            className={`flex flex-col items-center gap-0.5 px-4 py-1 rounded-lg transition-colors ${
              isActive("/app") ? "text-primary" : "text-on-surface-variant hover:text-on-surface"
            }`}
          >
          ...
          <Link
            href="/app/history"
            className={`flex flex-col items-center gap-0.5 px-4 py-1 rounded-lg transition-colors ${
              isActive("/app/history") ? "text-primary" : "text-on-surface-variant hover:text-on-surface"
            }`}
          >
